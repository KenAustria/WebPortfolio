		...
		<div>
			<section className={classes.profileSection}>
				...
				<ul className={classes.verticalLine}>
					<li className={[classes.project, classes.verticalLineContent].join(' ')}>
						<div className={[classes.projectDescription, classes.bulleted].join(' ')}>
							<div className={classes.projectName}>Burger Builder</div>
							<ul className={classes.projectDetails}>
								<li>
									<span class="project-details-label">
										<a className={classes.profile} href="https://burgerbuilder-be355.firebaseapp.com/" target="_blank">
											Live
										</a>
									</span>
								</li>
								<li>
									<span class="project-details-label">
										<a className={classes.profile} href="https://github.com/KenAustria/Burger-Builder" target="_blank">
											Source
										</a>
									</span>
								</li>
						...
						<p className={classes.projectInfo}>
							A React-Redux application for building burgers with the ability to create an order that is sent to Firebase.
            </p>
						<div className={[classes.projectImage, classes.burgerBuilder].join(' ')}>
					...
					<li className={[classes.project, classes.verticalLineContent].join(' ')}>
						<div className={[classes.projectDescription, classes.bulleted].join(' ')}>
							...
							<ul className={classes.projectDetails}>
								<li>
									<span class="project-details-label">
										<a className={classes.profile} href="http://kenaustria.com" target="_blank">
											Live
										</a>
									</span>
								</li>
								<li>
									<span class="project-details-label">
										<a className={classes.profile} href="https://github.com/KenAustria/WebPortfolio" target="_blank">
											Source
										</a>
									</span>
								</li>
						...
						<div className={[classes.projectImage, classes.portfolio].join(' ')}>
							<ul className={classes.projectTech}>
								<li>
									<i class="devicon-react-original" title="REACT"></i>
								</li>
